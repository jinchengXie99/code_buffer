...
/*硬件过流保护DAC值*/
#define DAC_OvercurrentValue            _Q7(I_ValueX(OverHardcurrentValue * 2))+0x7F  // HALF到VCC需加7F 
...
#define POWRAMPSTARTINC                 (P_Value(PowRampInc)) // /(1000/SPEEDRAMPTIME)            // 启动加速度 120RPM/S
#define POWRAMPSTARTDEC                 (P_Value(PowRampDec)) // /(1000/SPEEDRAMPTIME)            // 启动减速度 120RPM/S
